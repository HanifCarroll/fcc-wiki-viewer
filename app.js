async function search (query) {
	...
	const url = `https://cors-anywhere.herokuapp.com/https://en.wikipedia.org/w/api.php?format=json&action=query&generator=search&gsrnamespace=0&gsrsearch=${URI}&gsrlimit=10&prop=extracts&exintro&explaintext&exsentences=1&exlimit=max`;
